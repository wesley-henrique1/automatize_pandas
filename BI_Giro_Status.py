from config.config_path import relatorios, outros, output, col_names, wms
...
class Giro_Status:
    def __init__(self):
        self.lista_df = [
            relatorios.rel_96,relatorios.rel_f18    # PRODUTO
            ,outros.ou_86, outros.ou_f18            # ESTOQUE
            ,wms.wms_07_end, outros.ou_end          # ENDEREÇO
        ]
